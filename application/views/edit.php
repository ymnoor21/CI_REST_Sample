	    <div class="container">
	      	<div class="panel panel-default" style="margin-top: 20px;">
                ...
                <section style="padding: 20px;">
		      		<form name="update_user" method="POST" action="<?php echo $this->_apitesterBaseURL; ?>update">
                        <?php
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="pass" class="form-control" id="pass" placeholder="Password" value="">
                        </div>
                        <div class="form-group">
                            <label for="confirm_pass">Confirm Password</label>
                            <input type="password" name="confirm_pass" class="form-control" id="confirm_pass" placeholder="Confirm Password" value="">
                        </div>
						<div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="id" id="id" value="<?php if(isset($user)) echo $user[0]->id; ?>" />
                        </div>		
                        ...
                        if(isset($user)) {
                        ?>
                        <a href="javascript:void(0);" onclick="deleteUser(<?php if(isset($user)) echo $user[0]->id; ?>);" class="btn btn-default" role="button">
